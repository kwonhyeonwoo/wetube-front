...
import { useVideoViewsPostMutation } from '@/hooks/queries/video/useVideoMutation';
...
const VideoPlayContainer = ({ video, paramsId }: Props) => {
  const videoRef = useRef<HTMLVideoElement>(null);
  const hasTriggered3Sec = useRef(false);
  const {mutate} = useVideoViewsPostMutation(paramsId ?? "")
